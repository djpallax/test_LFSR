...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { clk }];  # clk 100MHz, T 100ns, 50%DC

## Switches
##set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { i_rst }]; #{ sw[0] }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
##set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { i_soft_reset }]; #{ sw[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
##set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { i_valid }]; #{ sw[2] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
##set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { i_corrupt }]; #{ sw[3] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]

## RGB LEDs
##set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { o_lock }]; #{ led0_b }]; #IO_L18N_T2_35 Sch=led0_b
...
## Pmod Header JA
##set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { i_seed[0] }]; #{ ja[0] }]; #IO_0_15 Sch=ja[1]
##set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { i_seed[1] }]; #{ ja[1] }]; #IO_L4P_T0_15 Sch=ja[2]
##set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { i_seed[2] }]; #{ ja[2] }]; #IO_L4N_T0_15 Sch=ja[3]
##set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { i_seed[3] }]; #{ ja[3] }]; #IO_L6P_T0_15 Sch=ja[4]
##set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { i_seed[4] }]; #{ ja[4] }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
##set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { i_seed[5] }]; #{ ja[5] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
##set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { i_seed[6] }]; #{ ja[6] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
##set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { i_seed[7] }]; #{ ja[7] }]; #IO_25_15 Sch=ja[10]
